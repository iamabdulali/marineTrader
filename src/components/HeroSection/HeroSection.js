...
const HeroSection = () => {
  ...
  return (
    <div className="relative hero-section-div bg-cover w-full lg:bg-top">
      ...
      />
      <div className="lg:absolute top-1/4 2xl:px-24 sm:px-10 px-6 lg:py-0 sm:py-10 py-5">
        <p className="text-white mb-3 flex items-center gap-3 sm:text-base text-sm">
          {" "}
          <span className="bg-[#FFB800] h-[2px] w-12 inline-block"></span> Buy
          and Sell {selectedCategory?.name || "Jet Skis"}
        </p>
        <p className="text-white sm:text-5xl text-3xl font-bold sm:leading-tight">
          Freedom is Just <br className="sm:block hidden" /> An Anchor{" "}
          <span className="text-[#FFB800]">Away</span>
        </p>
        <p className="text-white lg:w-6/12 w-full mt-3 sm:text-base text-sm">
          Lorem ipsum dolor sit amet, consectetur adipiscing elit. Ut elit
          tellus, luctus nec ullamcorper mattis.
        </p>
      </div>
      <div className="lg:absolute right-20 top-[17%] lg:w-5/12 w-full lg:px-0 sm:px-10 px-4 lg:py-0 sm:py-10 pb-10 pt-0">
        <CategoryDropdown
